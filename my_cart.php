...
<div id="wrapper">
	...
	<section> 
        ...
        <table width="100%"> 
            <tr> <th>Item Name</th> 
            <th>Description</th> 
            <th>Prices</th> <th>Actions</th> 
        </tr> <?php $cart = $_COOKIE['MyGameProducts']; 
        if ($cart) { 
            $i = 1; 
            ...
            foreach($items AS $item) {  
                ...
                if($result == false){ 
                    ...
                    while($row=mysqli_fetch_assoc($result)) { 
                        ...
                        echo '<td align="left">'.$row['price'].'</td>'; echo '<td align="left"><a href="my_cart.php?remove_id='.$i.'">Remove From Cart</a></td></tr>'; }  
                        $i++; 
                        } 
                    }
                } 
